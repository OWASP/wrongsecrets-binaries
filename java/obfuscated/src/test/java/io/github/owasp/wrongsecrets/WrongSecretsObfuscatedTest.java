...
/** Parity-contract smoke tests for the obfuscated Java CLI. */
class WrongSecretsObfuscatedTest {

  private static final String SECRET = "This is a harder secret in Java";
  ...
  private String run(String... args) {
    out.reset();
    WrongSecretsObfuscated.main(args);
